...
const navigation = {
  ...
  discover: [
    { name: "Alle escape games", href: "#" },
    { name: "Alle escape experiences", href: "#" },
    { name: "Alle escape walks", href: "#" },
    { name: "Activiteiten deals", href: "#" },
    { name: "Restaurant deals", href: "#" },
  ],
  Questions: [
    { name: "Blog", href: "#" },
    { name: "FAQ", href: "#" },
    { name: "Veiligheid", href: "#" },
  ],
  legal: [
          ...
          <div className="flex gap-x-6 md:order-2">
            {navigation.social.map((item) => (
              ...
              >
                ...
                <item.icon aria-hidden="true" className="size-6 fill-white" />
              </a>
            ))}
          </div>
        </div>
